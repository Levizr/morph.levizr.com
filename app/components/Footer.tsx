    ...
    <footer className="border-t border-border py-12 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-semibold">Morph</span>
          <span className="text-sm text-muted hover:underline"><a href="https://www.levizr.com" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
            by Levizr
          </a></span>
        </div>
        ...
        <div className="flex items-center gap-4 sm:gap-6 text-sm text-muted">
          ...
          <a
            ...
            className="w-8 h-8 rounded-lg border border-border bg-surface hover:bg-surface-hover flex items-center justify-center transition-all hover:scale-105"
          >
